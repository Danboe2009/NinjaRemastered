...
var BSprite : SpriteRenderer;
var SSprite : SpriteRenderer;
...
private var NAro : SpriteRenderer;
private var UAro : SpriteRenderer;

Back = GameObject.Find("Back");
NAro = GameObject.Find("NBlueArrow").GetComponent(SpriteRenderer);
UAro = GameObject.Find("UBlueArrow").GetComponent(SpriteRenderer);
...
function Update () 
{
	if(Selected == 1)
	{
		if(PlayerPrefs.GetInt("Slot1") == 1 && PlayerPrefs.GetInt("Unit1Level") < 20)
		{
			...
			Line2.text = UpgradesLanguage.thisLanguageManager.GetTextValue ("Upgrades.Attack") + " " + (2 + ((PlayerPrefs.GetInt("Unit1Level") - 1) * 4)) + " -> " + (2 + ((PlayerPrefs.GetInt("Unit1Level")) * 4));
		...
		if(PlayerPrefs.GetInt("Unit1Level") >= 20)
		{
			...
			Line2.text = UpgradesLanguage.thisLanguageManager.GetTextValue ("Upgrades.Attack") + " " + (2 + ((PlayerPrefs.GetInt("Unit1Level") - 1) * 4));
			Line3.text = "";
			Line4.text = "";
			Skil.text = "";
			Skil.color = Color.black;
