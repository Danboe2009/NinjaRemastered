...
private var POut : SpriteRenderer;
private var Blue : GameObject;
private var BOut : SpriteRenderer;
...
static var ScoreB : TextMesh;
static var SkillB : TextMesh;
...
POut = GameObject.Find("POutline").GetComponent(SpriteRenderer);
Blue = GameObject.Find("BlueCastle");
BOut = GameObject.Find("BOutline").GetComponent(SpriteRenderer);
