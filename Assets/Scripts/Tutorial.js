...
var PBASprite : SpriteRenderer;
var NBASprite : SpriteRenderer;
var LSprite : SpriteRenderer;
var RSprite : SpriteRenderer;
var NBAObject : GameObject;
var WWords : TextMesh;
var OniG : GameObject;
var time : float;
...
function Start () 
{
	...
	if(PlayerPrefs.GetInt("Tutorial") == 0)
	{
		if(Level != 1)
		{
			...
			LSprite.color = Color(1,1,1,0);
			RSprite.color = Color(1,1,1,0);
			WWords.text = "";
...
function TutorialLevel()
{
	...
	NBASprite.color = Color(1,1,1,1);
	NBAObject.transform.localScale = Vector3(-1.0,1.0,1.0);
