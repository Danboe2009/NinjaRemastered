...
//	Debug.Log(Tex.sprite.name);
	...
	if(debug)
	{
		...
		Debug.Log("Velocity: " + GetComponent.<Rigidbody>().velocity.x);
	...
	if(Dist < 11 && Dist != 0 && Castles.PinkHealth > 0) 
	{
	...
	if(Tex.sprite.name == "SwordLevelOneAtt3" || Tex.sprite.name == "SwordLevelTwoAtt3" || Tex.sprite.name == "SwordLevelThreeAtt3")
	{
		//Debug.Log("Attack");
		if(!Swipe)
		{
	...
	if(Tex.sprite.name == "NunchuckAttackLevelOne1" || Tex.sprite.name == "NunchuckAttackLevelTwo1" || Tex.sprite.name == "NunchuckAttackLevelThree1")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "NinjaStarLevelOneAtt5" || Tex.sprite.name == "NinjaStarLevelTwoAtt5" || Tex.sprite.name == "NinjaStarLevelThreeAtt5")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "LongBowLevelOneAtt5" || Tex.sprite.name == "LongBowLevelTwoAtt5" || Tex.sprite.name == "LongBowLevelThreeAtt5")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "StaffNinjaLevelOneAtt2" || Tex.sprite.name == "StaffNinjaLevelTwoAtt2" || Tex.sprite.name == "StaffNinjaLevelThreeAtt2")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "ChainAttackLevelOne1" || Tex.sprite.name == "ChainAttackLevelTwo1" || Tex.sprite.name == "ChainAttackLevelThree1")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "SiaAttackLevelOne1" || Tex.sprite.name == "SiaAttackLevelTwo1" || Tex.sprite.name == "SiaAttackLevelThree1")
	{
		if(!Swipe)
		{
			Swipe = true;
	...
	if(Tex.sprite.name == "HandClawAttackLevelOne2" || Tex.sprite.name == "HandClawAttackLevelTwo2" || Tex.sprite.name == "HandClawAttackLevelThree2")
	{
		if(!Swipe)
		{
			Swipe = true;
